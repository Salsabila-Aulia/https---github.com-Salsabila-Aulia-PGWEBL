...
class PolylinesModel extends Model
{
    ...
    {
        $polylines = $this
            ->select(DB::raw('polylines.id, st_asgeojson(polylines.geom) as geom, polylines.name, polylines.description, st_length(polylines.geom, true) as length_m, st_length(polylines.geom, true)/1000 as length_km, polylines.image, polylines.created_at, polylines.updated_at, polylines.user_id, users.name as user_created'))
